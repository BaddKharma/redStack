...
enable_external_vpn                  = true   # Set to true for HTB/THM/VulnLabs/PG — enables OpenVPN client + VPC routing (see Part 8)
enable_redirector_htaccess_filtering = false   # Set to false for HTB/THM/VulnLabs/PG — scanner/AV blocking not needed in lab environments
external_vpn_cidrs = ["10.10.0.0/16", "10.13.0.0/16", "10.129.0.0/16"]  # Adjust to match your platform's subnet ranges (check pushed routes on tun0 after connecting)
